     ...
     if((valor>0 || !isNaN(valor))  || (taxa>0 || !isNaN(taxa))   || (parcelas>0 || !isNaN(parcelas)) ){
        ...
        let simuladorA = new financiar(valor, taxa, parcelas);
            ...
            simuladorA.formataDados(); /* Faz as conversões para Int e Float */
              $("#resultado").html("");
              $("#resultado").append("<h3>SIMULAÇÃO PRICE ( Prestação Fixa )</h3><br>");
              ...
              $("#resultado").append("<h3>SIMULAÇÃO SAC ( Prestação Decrescente )</h3>");
...
},{"../controller/financiarController":1,"jquery":2}]},{},[3]);
